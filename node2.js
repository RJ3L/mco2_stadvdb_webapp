...
app.post('/api/read', async (req, res) => {
    ...
    try {
        ...
        const result = await db.selectQuery(query, "LIMIT 1", 1900, 2100, 2, isolationLevel);
...
app.post('/api/insert', async (req, res) => {
    ...
    try {
        ...
        const result = await db.insertQuery(insertQuery, parseInt(startYear), 2, isolationLevel, isDemoMode);
...
app.post('/api/delete', async (req, res) => {
    ...
    try {
        ...
        const result = await db.deleteQuery(id, parseInt(year), 2, isolationLevel, isDemoMode);
...
app.get('/api/database', async (req, res) => {
    try {
        const result = await db.selectQuery("", "ORDER BY tconst ASC LIMIT 10", 1900, 2100, 2);
